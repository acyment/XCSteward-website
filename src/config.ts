...
export const SITE = {
  ...
  description:
    'XCSteward is an open-source, local-first macOS tool for making XCTest, ' +
    'xcodebuild, and iOS Simulator runs more predictable when they hang at ' +
    'boot, destination resolution, simctl/CoreSimulator readiness, or under ' +
    'agent-driven concurrency.',
